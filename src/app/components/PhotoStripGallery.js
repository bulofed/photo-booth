  ...
  return (
    <section className='mt-12 pt-8 border-t border-gray-300'>
      <div className='flex justify-between items-center mb-4'>
        <h2 className='text-2xl font-bold text-indigo-500 m-0'>Your Photos Strips</h2>
        <button
          onClick={clearStrips}
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4'>
        {photoStrips.map((strip, index) => (
          <div key={index} className='bg-white rounded overflow-hidden hover:-translate-y-1 transition-transform'>
            <img
              src={strip}
            ...
            <button
              ...
              className='w-full py-3 bg-indigo-500 text-white flex justify-center items-center gap-2 hover:bg-indigo-800 transition-colors'
            >
              <FaDownload /> Download
            </button>
          </div>
